      ...
      <div class="posts-wrapper">
        <div class="post">
          <div class="inner-post">
            <img src="asset/images/image_7.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 5px; border-top-right-radius: 5px;">
            <div class="post-info">
        ...
        <div class="post">
          <div class="inner-post">
            <img src="asset/images/image_6.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 5px; border-top-right-radius: 5px;">
            <div class="post-info">
              <h4><a href="single.php">One day your life will flash before your eyes</a></h3>
                <div>
                  <i class="fa fa-user-o"></i> Awa Melvine
        ...
        <div class="post">
          <div class="inner-post">
            <img src="asset/images/image_5.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 5px; border-top-right-radius: 5px;">
            <div class="post-info">
              <h4><a href="single.php">One day your life will flash before your eyes</a></h3>
                <div>
                  <i class="fa fa-user-o"></i> Awa Melvine
        ...
        <div class="post">
          <div class="inner-post">
            <img src="asset/images/image_4.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 5px; border-top-right-radius: 5px;">
            <div class="post-info">
    ...
    <div class="content clearfix">
      <div class="page-content">
        ...
        <div class="post clearfix">
          <img src="asset/images/image_1.png" class="post-image" alt="">
        ...
        <div class="post clearfix">
          <img src="asset/images/image_2.png" class="post-image" alt="">
          <div class="post-content">
        ...
        <div class="post clearfix">
          <img src="asset/images/image_3.png" class="post-image" alt="">
          <div class="post-content">
